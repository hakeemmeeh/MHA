    ...
    <>
      ...
      <div className="bg-cream py-16">
        <div className="prose-navy mx-auto max-w-3xl space-y-6 px-6 font-inter text-sm leading-relaxed text-text-mid">
          ...
          <h2 className="font-playfair text-xl font-normal text-navy">Information we collect</h2>
          <p>
          ...
          <h2 className="font-playfair text-xl font-normal text-navy">How we use it</h2>
          ...
          <h2 className="font-playfair text-xl font-normal text-navy">Sharing</h2>
          <p>
          ...
          <h2 className="font-playfair text-xl font-normal text-navy">Retention</h2>
          <p>
          ...
          <h2 className="font-playfair text-xl font-normal text-navy">Your rights</h2>
          <p>
